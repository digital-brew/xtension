<?php
  ...
  class JQuery
  {
    ...
    {
      if (!config('xtension.frontend.jquery.main.enabled')) {
    ...
    {
      if (!config('xtension.frontend.jquery.migrate.enabled')) {
    ...
    {
      if ((config('xtension.frontend.jquery.main.enabled') && config('xtension.frontend.jquery.main.use_cdn')) ||
          (config('xtension.frontend.jquery.migrate.enabled') && config('xtension.frontend.jquery.migrate.use_cdn'))) {
        Action::add( [ 'wp_enqueue_scripts', 'login_enqueue_scripts' ], function () {
          ...
          if ( ! is_admin() ) {
            ...
            if (config('xtension.frontend.jquery.main.custom_version') !== null) {
              $wp_jquery_ver = config('xtension.frontend.jquery.main.custom_version');
            }

            if (config('xtension.frontend.jquery.migrate.custom_version') !== null) {
              $wp_jquery_migrate_ver = config('xtension.frontend.jquery.migrate.custom_version');
            }
            ...
            if (config('xtension.frontend.jquery.migrate.enabled') && config('xtension.frontend.jquery.migrate.use_cdn')) {
